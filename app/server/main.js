...
Meteor.startup(() => {
  ...
  if (TypesCollection.find().count() === 0) {
    [
      ...
      { id: "studio", name: "Movie Studio", upgradeRate: 1.13, profit: 4320, duration: 12, initialCost: 179159040 },
      { id: "bank", name: "Bank", upgradeRate: 1.13, profit: 4320, duration: 12, initialCost: 2149908480 },
      { id: "oil", name: "Oil Company", upgradeRate: 1.13, profit: 4320, duration: 12, initialCost: 25798901760 },
    ].forEach(insertType);
  }
